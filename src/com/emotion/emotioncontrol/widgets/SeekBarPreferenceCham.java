package com.emotion.emotioncontrol.widgets;
...
public class SeekBarPreferenceCham extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String EMOTION = "http://schemas.android.com/apk/res/com.emotion.emotioncontrol";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mMinValue = attrs.getAttributeIntValue(EMOTION, "min", 0);
        mDefaultValue = attrs.getAttributeIntValue(EMOTION, "defaultVal", -1);
        mUnitsLeft = getAttributeStringValue(attrs, EMOTION, "unitsLeft", "");
        String units = getAttributeStringValue(attrs, EMOTION, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, EMOTION, "unitsRight", units);
        ...
        try {
            String newInterval = attrs.getAttributeValue(EMOTION, "interval");
            if(newInterval != null)
