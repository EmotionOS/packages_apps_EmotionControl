 ...
 * <li>emotion:colorPickerDefaultValue - default color.
 * <li>emotion:colorPickerShowAlphaSlider - a @string reference, which will be set as the summary when disabled.
 * </ul>
 */
