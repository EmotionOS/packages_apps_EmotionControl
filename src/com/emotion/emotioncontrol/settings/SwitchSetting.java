 ...
 * <li>emotion:descriptionOn - a @string reference, which will be set as the summary when enabled.
 * <li>emotion:descriptionOff - a @string reference, which will be set as the summary when disabled.
 * </ul>
 */
