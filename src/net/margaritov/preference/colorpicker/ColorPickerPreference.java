...
public class ColorPickerPreference extends Preference implements
    ...
    static final String EMOTION_NS = "http://schemas.android.com/apk/res-auto";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int defVal = attrs.getAttributeIntValue(EMOTION_NS, "defaultColorValue", DEF_VALUE_DEFAULT);
